package com.sss.community.event;
...
import com.sss.community.service.MessageService;
...
//                    Thread.sleep(5000);
                    ...
                    // mime:上传类型
                    Response response =
                            manager.put(path, fileName, uploadToken, null,
                ...
                } catch (QiniuException /*| InterruptedException*/ e) {
                    logger.info(String.format("第%d次上传失败[%s].", uploadTimes, fileName));
                }
            } else {
